...
#ifndef _ServoCtrl_Driver_H
#define _ServoCtrl_Driver_H
...
public:
    ...
    ServoCtrlDriver(){};   //Constructor sin inicialización
   
 
    void Init(PWMServoDriver *pwm,int pin);  //  si se inicializarona las variables  controlador y salida usada
